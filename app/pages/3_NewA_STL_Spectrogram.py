...
# Gets current script directory, or fallback to working directory
BASE_DIR = pathlib.Path(__file__).resolve().parent if "__file__" in globals() else pathlib.Path(os.getcwd())
csv_path = pathlib.Path(r"E:\IND320-Project-Part1\notebook\elhub_production.csv")


# Try loading the file
try:
    elhub_df = pd.read_csv(csv_path)
